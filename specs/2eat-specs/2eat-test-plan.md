...
| Agent HTTP 用例 | [`../agent-specs/8.user-test-cases.md`](../agent-specs/8.user-test-cases.md) |
...
| Retrospective | [`what2eat-mvp3-lessons.md`](../knowledge/web-app-development/what2eat-mvp3-lessons.md)；ADR-027 / ADR-028 |
...
| Retrospective | [`what2eat-mvp4-lessons.md`](../knowledge/web-app-development/what2eat-mvp4-lessons.md) + follow-ups；ADR-029（drafts）；ADR-031（空 AMAP→Google，places-agent） |
...
Agent 层 live 探针细节见 [`../agent-specs/4.test-strategy.md`](../agent-specs/4.test-strategy.md) 与 [`8.user-test-cases.md`](../agent-specs/8.user-test-cases.md) — 此处不重复 TC 明细。
