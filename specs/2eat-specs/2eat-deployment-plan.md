...
**what2eat 专属**部署输入。家族总览、端口注册 §0、NPM/Portainer 通用流程见 [`../6.deployment-plan.md`](../6.deployment-plan.md) 与 [`../../0.2.release-bot/`](../../0.2.release-bot/)。release-bot 逐步操作见 `0.2.release-bot/knowledge/03-semi-auto-release.md`。
...
| 家族技术锁定 | [`../3.tech-specs.md`](../3.tech-specs.md) |
...
| 产物 | 状态 |
| --- | --- |
| Next app + BFF（`what2eat/`） | **Has**（同步至 GitHub repo 后再 GHCR） |
...
勿占用 **3007**（places-agent）。端口全表见 [`../6.deployment-plan.md`](../6.deployment-plan.md) §0。
...
```text
Terminal A: cd places-agent && make dev     # :3010
Terminal B: cd what2eat && make up          # Postgres :5435 + app :3020
```
...
| 文档 | 角色 |
| --- | --- |
| [`../6.deployment-plan.md`](../6.deployment-plan.md) | 家族三栈与端口 §0 |
| [`../2.architecture.md`](../2.architecture.md) | 信任拓扑 |
