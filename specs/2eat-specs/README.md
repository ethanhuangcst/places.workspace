...
**what2eat**（`what2eat.food`）产品规格，位于 monorepo `specs/2eat-specs/`。
...
| [../2.architecture.md](../2.architecture.md) | 家族架构、BFF 信任边界 |
| [../3.tech-specs.md](../3.tech-specs.md) | 锁定技术栈版本 |
| [../6.deployment-plan.md](../6.deployment-plan.md) | 家族部署总览、端口注册 §0 |
| [../agent-specs/](../agent-specs/) | places-agent 工具与 HTTP 契约 |
