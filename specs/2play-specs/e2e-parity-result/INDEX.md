...
>
> **Agent 基线：** [`../../agent-specs/e2e-test-result/INDEX.md`](../../agent-specs/e2e-test-result/INDEX.md)（27/30 通过，2026-09-02）。
...
cd where2play && python3 e2e/test_agent_parity_30.py --compare
```
