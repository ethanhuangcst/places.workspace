...
**where2play**（`where2play.place`）产品需求。地图工具、vendor 密钥、**L1 候选发现**在 **places-agent**；**L2 按天排程与行程助手**在 where2play BFF 本应用 **Qwen**（[ADR-047](../adr/ADR-047-qwen-primary-llm.md)；历史 ADR-036/037）。家族架构见 [`../2.architecture.md`](../2.architecture.md)；agent 能力见 [`../agent-specs/`](../agent-specs/)；地图/引擎边界见 [ADR-008](../adr/ADR-008-itinerary-ownership.md)。设计规格见 [`2play-design.md`](./2play-design.md)。用户故事与 AC 见 [`2play-stories.md`](./2play-stories.md)。测试与质量门见 [`2play-test-plan.md`](./2play-test-plan.md)。持久化见 [ADR-033](../adr/ADR-033-where2play-postgres-prisma.md)。
