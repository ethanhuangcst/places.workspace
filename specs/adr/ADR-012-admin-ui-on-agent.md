...
1. The **operator management UI ships inside the places-agent deployable**: same git repo (`places-agent/`), same image, same Portainer stack, same hostname `places.agent-mate.ai`.
