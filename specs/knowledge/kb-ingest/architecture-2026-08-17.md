...
Parent places-workspace: umbrella specs only (github.com/ethanhuangcst/places.workspace.git). Children (gitignored from parent): 0.1.sdd.sample, 0.2.release-bot, places-agent, what2eat, where2play.
