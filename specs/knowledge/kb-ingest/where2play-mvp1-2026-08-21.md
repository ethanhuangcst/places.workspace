...
| --- | --- | --- |
| ADR-033 | `../../adr/ADR-033-where2play-postgres-prisma.md` | where2play dedicated Postgres; thin-app LLM boundary |
| Next env + CSS | `../../2play-specs/knowledge/next-env-css-mvp1.md` | Empty SESSION_SECRET override; Tailwind `@import` 500 |
| MVP-1 quality gate | `../../2play-specs/knowledge/mvp1-quality-gate.md` | `make quality` coverage + with_server reuse |
| MVP-1 close | `../../2play-specs/knowledge/where2play-mvp1-close.md` | Slice close + usability confirm |
