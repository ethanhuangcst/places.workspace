...
tags:
  ...
  - i18n
  - header
related_spec: ../../2eat-specs/2eat-design.md
related:
...
- Implemented in `what2eat/src/ui/app-header.tsx`, `messages/{CN,HK,TW}.json`, mock `ui-mockup/` + `i18n.js`, and `2eat-stories.md` `header-01`.
...
- Spec: [`2eat-design.md` §1.3](../../2eat-specs/2eat-design.md)
- Stories: [`2eat-stories.md` header-01](../../2eat-specs/2eat-stories.md)
