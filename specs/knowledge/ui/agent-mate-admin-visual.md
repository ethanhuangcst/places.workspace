...
tags:
  ...
  - places-agent
  - kb-agent
related_spec: ../../agent-specs/3.ui-design.md
related:
...
places.agent-mate.ai operator chrome matches [kb.agent-mate.ai](https://kb.agent-mate.ai): `#fafafa` field, black ink, hairline rules, radius 0. Personality is only `agent-logo.png`. Pixel contract: [`3.ui-design.md`](../../agent-specs/3.ui-design.md). Clickable mock-ups: [`ui-mockup/`](../../agent-specs/ui-mockup/).
...
- Spec: [`3.ui-design.md`](../../agent-specs/3.ui-design.md)
