...
**产品选用（2026-09-20）。** 故事 `agent-meal-116`（**Done** · 下限）· `agent-meal-118`（**Done** · 类型 + 贝叶斯）。骨架维持 [ADR-049](../../adr/ADR-049-verified-attraction-and-meal-slots.md) D3 餐档；fill 零 LLM 现搜；用供应商字段排序/闸。
