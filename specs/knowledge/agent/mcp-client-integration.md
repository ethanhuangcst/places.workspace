...
tags:
  ...
  - cursor
  - chatbox
related_spec: ../../agent-specs/6.agent-deployment.md
related:
...
- Routing in `places-agent/server.ts`: `/mcp` → Streamable HTTP; `/sse` → GET opens SSE, POST may initialize MCP (ChatBox pattern).
...
- User test cases: `../../agent-specs/8.user-test-cases.md`
- Deployment § MCP: `../../agent-specs/6.agent-deployment.md`
