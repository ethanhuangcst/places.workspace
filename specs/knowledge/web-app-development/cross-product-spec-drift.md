...
1. **三仓独立进度：** `places-agent` / `where2play` / `../..` 可各自改 stories；交叉引用靠人手。  
...
- [performance.md](../../agent-specs/performance.md)  
- [itinerary-design.md](../../2play-specs/itinerary-design.md)
...
**Target：** [ADR-050](../../adr/ADR-050-where2play-no-product-llm.md) — where2play **零产品 LLM**；编排 [`real-agent-refactory.md`](../../agent-specs/real-agent-refactory.md)（`plan_trip` + `fetch_trip_details`）。
