...
- `where2play/e2e/run.py`: shared `e2e_env()` + `app_dev_cmd()`; mvp2/mvp3/chat02 pass `DATABASE_URL`.
- `where2play/Makefile`: `test-e2e-mvp3-live` sets `PLAN_SLOT_STAGE_MS=0`.
