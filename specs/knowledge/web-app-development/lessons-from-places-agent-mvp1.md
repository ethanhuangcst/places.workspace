...
tags:
  ...
  - i18n
  - places-agent
related_spec: ../../agent-specs/4.test-strategy.md
related:
  ...
  - ../../agent-specs/7.auth-refactor-plan.md
---
...
| Nested git | Workspace root Grep/Glob often miss `places-agent/` (own `.git`). Search inside that repo. |
...
- Consolidated 9 spec files → 4 (removed numbered prefixes, merged UI design into agent-design, merged test cases into test-strategy, deleted completed auth refactor plan, moved deployment to ../..).
...
- Auth refactor decision log: `../../agent-specs/7.auth-refactor-plan.md`
- Test strategy: `../../agent-specs/4.test-strategy.md`
